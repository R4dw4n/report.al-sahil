...
const UploadModal = (props) => {
  ...
  const [fileList, setFileList] = useState(
    props.data[props.index]?.arr[props.i]?.image_path ? [{
      uid: -10,
      url: HOST + "/storage/" + props.data[props.index].arr[props.i]?.image_path,
      thumbUrl: HOST + "/storage/" + props.data[props.index].arr[props.i]?.image_path,
      status: 'done',
    }] : []
  );
  useEffect(() => {
